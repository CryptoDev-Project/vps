...
The script will also work with Digital Ocean. Please sign up using the link below if you haven't already:

<a href="https://m.do.co/c/164caf691718">https://m.do.co/c/164caf691718</a>
...
```bash
git clone https://github.com/CryptoDev-Project/vps.git && cd vps
```
...
I activated the "[issues](https://github.com/CryptoDev-Project/vps/issues)" option on github to give you a way to document defects and feature wishes. Feel free top [open issues](https://github.com/CryptoDev-Project/vps/issues) for problems / features you are missing here: [https://github.com/CryptoDev-Project/vps/issues](https://github.com/CryptoDev-Project/vps/issues).
